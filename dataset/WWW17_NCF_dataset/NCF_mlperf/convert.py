...
from NCF_dataset.load import implicit_load
...
def parse_args():
    ...
    parser.add_argument('--path', type=str, default='./ml-1m.dat',
...
def main():
    ...
    for user in tqdm(range(len(original_users)), desc='Users', total=len(original_users)):  # noqa: E501
        ...
        all_negs = all_items - set(user_to_items[user])  # all_negs include test_item
